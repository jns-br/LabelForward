module.exports = {
  ...
  selectNextText: "SELECT text_id, text_data, uncertainty FROM text_data WHERE NOT ($1 = ANY (users)) AND WHERE NOT predicted_label = 'ignored' ORDER BY uncertainty ASC LIMIT 1",
  selectNextTextIgnored: "SELECT text_id, text_data, uncertainty FROM text_data WHERE NOT ($1 = ANY (users)) ORDER BY uncertainty ASC LIMIT 1",
